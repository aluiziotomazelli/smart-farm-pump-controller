...
public:
    ...
    MOCK_METHOD(esp_err_t, handle_operator_start, (farm::PowerSource source), (override));
    MOCK_METHOD(esp_err_t, handle_operator_stop, (), (override));
    MOCK_METHOD(void, set_source_lock, (farm::PowerSource source), (override));
    ...
    MOCK_METHOD(farm::PowerSource, get_locked_source, (), (const, override));
